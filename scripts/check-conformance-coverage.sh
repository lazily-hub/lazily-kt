...
#
# Pinned at 157 after the reactive-graph migration (#lzktbindpending). In normal work
...
# from the start: `${VAR-157}` substitutes the default only when the variable is
# UNSET, where `${VAR:-157}` would also have swallowed `export
...
EXPECTED_LEDGERED_BLOCKS="${EXPECTED_LEDGERED_BLOCKS-157}"
