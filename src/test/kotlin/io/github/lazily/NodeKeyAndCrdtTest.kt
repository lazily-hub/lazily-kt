...
class NodeKeyAndCrdtTest {
    ...
    // The fixture is a raw-string JSON literal: wrapping it would change the bytes
    // under test, so the length is a property of the fixture, not of the code style.
    ...
    fun `crdt sync accepts an absent crdt_op key`() {
        ...
        assertEquals(
            ...
            back.sync.ops
                .first()
                .key,
            "absent key must decode to null",
        )
    }
